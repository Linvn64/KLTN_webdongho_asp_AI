...
namespace WebDongHoLG.Areas.Identity.Pages.Account
{
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    var moiNguoiDung = new NguoiDung
                    {
                        UserId = currentUserId,
                        HoTen = Input.UserName,
                        Email = Input.Email,
                        NgayTao = DateTime.Now
                    };

                    _context.NguoiDungs.Add(moiNguoiDung);
                    ...
                    var callbackUrl = Url.Page(
                        ...
                        pageHandler: null,
                        values: new { area = "Identity", userId = currentUserId, code = code, returnUrl = returnUrl },
                ...
                foreach (var error in result.Errors)
                {
                    ...
                    if (message.Contains("Password"))
                        message = "Mật khẩu chưa đúng yêu cầu (có thể thiếu chữ hoa, số hoặc ký tự đặc biệt).";
