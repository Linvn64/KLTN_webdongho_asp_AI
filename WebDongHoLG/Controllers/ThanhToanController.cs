    ...
    public class ThanhToanController : Controller
    {
        ...
        public async Task<IActionResult> PaymentCallBackMomo()
        {
            ...
            if (maDonHang > 0)
            {
                if (finalCode == "0")
                {
                    ...
                    HttpContext.Session.Remove("PendingOrderId");
                    TempData["ToastSuccess"] = "Thanh toán MoMo thành công!";
                    return RedirectToAction("OrderSuccess", "Checkout", new { maDonHang });
                }
                else
                {
                    ...
                    return RedirectToAction("PaymentPending", "Checkout", new { maDonHang });
                }
            }
        ...
        public async Task<IActionResult> PaymentCallbackVnpay()
        {
            ...
            if (thanhCong && maDonHang.HasValue)
            {
                ...
                HttpContext.Session.Remove("PendingOrderId");
                TempData["ToastSuccess"] = "Thanh toán VNPay thành công!";
                return RedirectToAction("OrderSuccess", "Checkout", new { maDonHang = maDonHang.Value });
            }
            ...
            if (maDonHang.HasValue)
            {
                ...
                if (responseCode == "24" || responseCode == "11")
                    return RedirectToAction("PaymentPending", "Checkout", new { maDonHang = maDonHang.Value });
            }
